...
This means one can have an always-on merged instance running, and another local pointd/point-qt instance which connects to this node and receives blocks from it.
