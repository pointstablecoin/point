Point Core version 3.0.6 is now available from:
  ...
  <https://github.com/POINT-project/POINT/releases>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/POINT-project/POINT/issues>


How to Upgrade
==============

If you are running an older version, shut it down. Wait until it has completely shut down (which might take a few minutes for older versions), then run the installer (on Windows) or just copy over /Applications/Merge-Qt (on Mac) or pointd/point-qt (on Linux).
...
---------------------
Many areas of the block validation code use a "slow" transaction search, which searches redundantly for transactions. This "slow" search has been removed upstream in Bitcoin and is now removed in POINT. This provides a more efficient syncing process and generally better performing wallet.
