...
1. Clone the github tree to get the source code and go into the directory.
        ...
        git clone https://github.com/POINT-Project/POINT.git
        cd POINT
...
pointd/point-cli binaries are not included in The Merge-Qt.app bundle.

If you are building `pointd` or `point-qt` for others, your build machine should be set up
...
commands:
    ...
    echo -e "rpcuser=POINTrpc\nrpcpassword=$(xxd -l 16 -p /dev/urandom)" > "/Users/${USER}/Library/Application Support/POINT/POINT.conf"
    chmod 600 "/Users/${USER}/Library/Application Support/POINT/POINT.conf"

The next time you run it, it will start downloading the blockchain, but it won't
output anything while it's doing this. This process may take several hours;
you can monitor its process by looking at the debug.log file, like this:

    tail -f $HOME/Library/Application\ Support/POINT/debug.log

Other commands:
-------

    ./pointd -daemon # to start The Point daemon.
