...
In order to support loading of multiple wallets in point-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is POINT.cpp.
...
Changes to POINT.cpp
----------------------
POINT.cpp is the entry point into point-qt, and as such, will require some minor modifications to provide hooks for
